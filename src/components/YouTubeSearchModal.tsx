          ...
          <div className='flex gap-2'>
            <div className='relative flex-1'>
              ...
              <input
                ...
                className='w-full pl-9 pr-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none input-ring'
              />
            </div>
            <button
          ...
          <div className='space-y-2'>
            {results.map((item) => (
              <button
                ...
                className='w-full flex items-center gap-3 p-2.5 rounded-2xl hover:bg-gray-50 active:bg-gray-100 transition-colors text-left'>
                {/* Miniatura */}
                <div
